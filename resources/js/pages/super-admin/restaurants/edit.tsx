...
import type { BreadcrumbItem, Company, Restaurant } from '@/types';
...
export default function RestaurantEdit({ restaurant, companies }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        company_id: restaurant.company_id.toString(),
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/super-admin/restaurants/${restaurant.id}`);
    };
                ...
                <div className="max-w-2xl mx-auto w-full">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update branch details for {restaurant.name}.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
