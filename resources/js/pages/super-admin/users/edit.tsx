...
import type { BreadcrumbItem, User, Role, Company, Restaurant } from '@/types';
...
export default function UserEdit({ user, roles, companies, restaurants }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        restaurant_ids: user.restaurants?.map(r => r.id.toString()) || [] as string[],
    });
                ...
                <div className="max-w-2xl mx-auto w-full">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update user details and permissions for {user.name}.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Select 
                                            ...
                                            onValueChange={(value) => setData('company_id', value === 'none' ? '' : value)}
                                        >
                                            <SelectTrigger>
