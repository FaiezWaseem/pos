...
import type { BreadcrumbItem, Employee, Restaurant, Role, SharedData } from '@/types';
...
export default function EmployeeEdit({ employee, restaurants, roles }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        restaurant_id: employee.restaurant_id.toString(),
        name: employee.user?.name || '',
        email: employee.user?.email || '',
        password: '',
        role_id: employee.user?.role_id?.toString() || '',
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/staff/employees/${employee.id}`);
    };
                ...
                <div className="max-w-3xl mx-auto w-full">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update staff account and employee details.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
